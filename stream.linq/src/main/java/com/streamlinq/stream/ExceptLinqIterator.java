...
class ExceptLinqIterator<TSource, TKey> extends LinqIterator<TSource>
{
        ...
        public ExceptLinqIterator(Iterable<TSource> first, Iterable<TSource> second, Func_T_R<TSource, TKey> keyselector, EqualityComparer<TSource> equalitycomparer)
        {
                this.first = first;
                this.second = second;
        ...
        {
                return new ExceptLinqIterator<TSource, TKey>(this.first, this.second, this.keyselector, (EqualityComparer<TSource>)this.equalityComparer);
        }
